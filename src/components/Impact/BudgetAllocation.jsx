...
const BudgetAllocation = () => {
	...
	return (
		<section className="budget-section animate-on-scroll" id="budget-section">
			<h2 className="section-title">Delhi Budget 2025-26: Water & Sanitation Breakdown</h2>
			<p className="section-description">How the ₹9,000 crore water and sanitation budget is allocated across different interventions.</p>
			<div className="budget-chart-wrapper">
				<ReactECharts option={getTreemapOption()} style={{ height: "450px" }} />
			</div>
			<div className="budget-note">
				Note: While ₹500 crore is specifically allocated for Yamuna cleanup and another ₹500 crore for STP repairs, the challenge lies in
				timely execution and addressing sewage from rapidly growing unauthorized settlements.
			</div>
		</section>
	);
};
